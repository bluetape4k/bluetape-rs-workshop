...
def svg_header(d: Diagram) -> str:
  ...
  <defs>
    ...
    <marker id="arrow-main" viewBox="0 0 10 10" markerWidth="10" markerHeight="10" refX="9" refY="5" orient="auto" markerUnits="userSpaceOnUse" data-role="secondary" data-tip-direction="positive-x"><path d="M 1 1 L 9 5 L 1 9 Z" fill="#47616f" stroke-dasharray="none"/></marker>
    <marker id="arrow-success" viewBox="0 0 10 10" markerWidth="10" markerHeight="10" refX="9" refY="5" orient="auto" markerUnits="userSpaceOnUse" data-role="secondary" data-tip-direction="positive-x"><path d="M 1 1 L 9 5 L 1 9 Z" fill="#4f8b63" stroke-dasharray="none"/></marker>
    <marker id="arrow-error" viewBox="0 0 10 10" markerWidth="10" markerHeight="10" refX="9" refY="5" orient="auto" markerUnits="userSpaceOnUse" data-role="secondary" data-tip-direction="positive-x"><path d="M 1 1 L 9 5 L 1 9 Z" fill="#b95f7a" stroke-dasharray="none"/></marker>
    <marker id="arrow-amber" viewBox="0 0 10 10" markerWidth="10" markerHeight="10" refX="9" refY="5" orient="auto" markerUnits="userSpaceOnUse" data-role="secondary" data-tip-direction="positive-x"><path d="M 1 1 L 9 5 L 1 9 Z" fill="#a78335" stroke-dasharray="none"/></marker>
    <style>
